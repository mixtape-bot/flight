...
public annotation class Greedy(val type: Type = Type.Normal, val min: Int = 1, val max: Int = Int.MAX_VALUE) {
    public companion object {
        public val Greedy.range: IntRange
            get() = min..max
    }

    public enum class Type { Computed, Normal }
}
